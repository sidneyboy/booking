    ...
    <div class="wrapper">
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="../../index3.html" class="brand-link">
          <img src="{{ asset("/adminLte/julmar.png") }}"
          alt="AdminLTE Logo"
        ...
        <div class="sidebar">
          ...
          <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item">
                <a href="{{ url('location_upload') }}"  class="nav-link {{ $active == 'location_upload' ? 'active' : '' }}">
              ...
              <li class="nav-item">
                <a href="{{ url('principal_upload') }}"  class="nav-link {{ $active == 'principal_upload' ? 'active' : '' }}">
                  <i class="nav-icon fas fa-th"></i>
                  <p>
                    Principal Upload
              ...
              <li class="nav-item">
                <a href="{{ url('customer_upload') }}"  class="nav-link {{ $active == 'customer_upload' ? 'active' : '' }}">
                  <i class="nav-icon fas fa-th"></i>
                  <p>
                    Customer Upload
